...
case "$CHAIN" in
  bsc)
    ...
    WARP_ISM="0xF6b0cDD33A7d2895a3F18b85569Ed9A8278cD151"   # ISM do warp p/ TC→BSC (mutável, 3-de-4 — 20/08/2026)
  ...
  ethereum)
    ...
    WARP_ISM="0x3ba17675f0D319C89D70722f6eb07790DF0B254B"   # ISM do warp p/ TC→ETH (mutável, 3-de-4 — 20/08/2026)
